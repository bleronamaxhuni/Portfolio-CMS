...
<body class="bg-[#f0f4ff] text-gray-800 font-sans">
    ...
    <header class="fixed top-0 left-0 w-full bg-white shadow z-50">
        <nav class="max-w-6xl mx-auto flex justify-between items-center p-4">
            ...
            <ul class="flex gap-6">
                <li><a href="#experiences" class="text-gray-700 hover:text-blue-600">Experiences</a></li>
                <li><a href="#skills" class="text-gray-700 hover:text-blue-600">Skills</a></li>
    ...
    {{-- About Me section --}}
    <section class="min-h-screen flex items-center bg-[#f0f4ff] px-6 md:px-20">
        <div class="flex flex-col md:flex-row items-center gap-16 w-full">
            ...
            <div class="flex-1 flex justify-center">
                <div class="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden bg-white shadow-2xl flex items-center justify-center transform transition-transform hover:scale-105">
    ...
    <section id="experiences" class="py-16 bg-gray-50">
        ...
        <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
            @foreach($experiences as $exp)
                <div class="p-6 bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300">
    ...
    <section id="skills" class="py-16">
        ...
        <div class="max-w-5xl mx-auto flex flex-wrap justify-center gap-4">
            @foreach($skills as $skill)
                <span class="px-5 py-2 bg-blue-100 text-blue-800 rounded-full font-medium shadow-sm hover:bg-blue-200 transition-colors duration-300">
                    {{ $skill->name }}
                </span>
            @endforeach
        </div>
